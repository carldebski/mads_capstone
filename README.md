...
<br><br>
Note, <b>koigawa/nlp_sagemaker_app/nlp</b> contains modification to codes originally from [AWS SageMaker sample code repository](https://github.com/aws/amazon-sagemaker-examples/tree/main/advanced_functionality/scikit_bring_your_own) licensed under Apache License Version 2.0.
In addition, some parts of the code in other subfolders under <b>koigawa</b> have been informed based on results generated by ChatGPT. In such cases, mention has been added at the top of the files.
